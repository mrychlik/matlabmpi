...
tic;
count0 = mandel(x1, x2, y1, y2,gridSize,maxIterations,radius);
disp('Non-parallel time');toc
fig; 
...
axis off
title( sprintf( '%1.2f secs (without GPU, num. workers: %d, radius: %1.2f, radius)', cpuTime, p.NumWorkers, radius ) );
